...
export default function RomanticBirthdayPage() {
  ...
  useEffect(() => {
    ...
    const heartArray = Array.from({ length: 80 }, (_, i) => ({
      ...
      size: Math.floor(Math.random() * (12 - 4) + 4),
      color: ['pink-400', 'rose-400', 'purple-400'][Math.floor(Math.random() * 3)],
      fillColor: ['pink-300', 'rose-300', 'purple-300'][Math.floor(Math.random() * 3)],
  ...
  useEffect(() => {
    // Auto-play audio when component mounts and audio is ready
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-rose-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        {hearts.map((heart) => (
          ...
          >
            <Heart className={`w-${heart.size} h-${heart.size} text-${heart.color} fill-${heart.fillColor}`} />
          </div>
        ))}
      </div>
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 font-light italic mb-12">{'To the most beautiful soul I know ✨'}</p>
          </div>
        </section>

        {/* New Birthday Message Section with last image on top */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-pink-100">
              ...
              <div className="mx-auto mb-8 w-28 h-28 rounded-full overflow-hidden shadow-lg animate-bob-slow ring-2 ring-pink-200">
                <Image
                  src={samplePhotos[samplePhotos.length - 1] || "/placeholder.svg"}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {samplePhotos.map((photo, index) => (
                ...
                >
                  <Image src={photo || '/placeholder.svg'} alt={`Memory ${index + 1}`} width={300} height={300} className="w-full h-80 object-cover" />
